                ...
                @endforeach
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							<h1 class="name">@if(session()->get('language') == 'sinhala') {{$product->product_name_sin}} @else {{$product->product_name_en}} @endif</h1>
							...
							<div class="description-container m-t-20">
								@if(session()->get('language') == 'sinhala') {{$product->short_descp_sin}} @else {{$product->short_descp_en}} @endif
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<div class="price-box">
											<span class="price">Rs {{ number_format($product->selling_price,2)}}</span>
										</div>
										@else
										<div class="price-box">
											<span class="price">Rs {{ number_format($product->discount_price,2)}}</span>
											<span class="price-strike">Rs {{ number_format($product->selling_price,2)}}</span>
										</div>
										@endif
									</div>
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">@if(session()->get('language') == 'sinhala') {!! $product->long_descp_sin !!} @else {!! $product->long_descp_en !!} @endif</p>
									</div>	
								</div><!-- /.tab-pane -->
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="assets/images/blank.gif" data-echo="{{ asset('frontend/assets/images/products/p5.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="assets/images/blank.gif" data-echo="{{ asset('frontend/assets/images/products/p6.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
