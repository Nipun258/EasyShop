        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          ...
          <nav class="yamm megamenu-horizontal">
            <ul class="nav">
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon {{$category->category_icon}}" aria-hidden="true"></i>@if(session()->get('language') == 'sinhala') {{$category->category_name_sin}} @else {{$category->category_name_en}} @endif</a>
              ...
              @endforeach
              <!-- /.menu-item -->
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-paper-plane"></i>@if(session()->get('language') == 'sinhala') කුඩා ළමුන්ගේ උපකරණ @else Kids and Babies @endif</a> 
                <!-- /.dropdown-menu --> </li>
              
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-futbol-o"></i>@if(session()->get('language') == 'sinhala') ක්‍රීඩා උපකරණ @else Sports @endif</a> 
              
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-envira"></i>@if(session()->get('language') == 'sinhala') වත්තේ හා ගේදොර උපකරණ @else Home and Garden @endif</a> 
                <!-- /.dropdown-menu --> </li>
            </ul>
            <!-- /.nav --> 
          </nav>
            ...
            <div class="row">
              <div class="col-md-6 col-sm-4 col-lg-4">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green">@if(session()->get('language') == 'sinhala') මුදල් ආපසු ගෙවීම් @else money back @endif</h4>
                    </div>
                  </div>
                  <h6 class="text">@if(session()->get('language') == 'sinhala') දින 30 ක දී මුදල් ආපසු ලබා ගැනීමේ හැකියාව @else 30 Days Money Back Guarantee @endif</h6>
                </div>
              </div>
              <!-- .col -->
              ...
              <div class="hidden-md col-sm-4 col-lg-4">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green">@if(session()->get('language') == 'sinhala') නොමිලේ භාණ්ඩ ප්‍රවාහනය @else free shipping @endif</h4>
                    </div>
                  </div>
                  <h6 class="text">@if(session()->get('language') == 'sinhala') $99 වැඩි භාණ්ඩ සදහා @else Shipping on orders over $99 @endif</h6>
                </div>
              </div>
              <!-- .col -->
              ...
              <div class="col-md-6 col-sm-4 col-lg-4">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green">@if(session()->get('language') == 'sinhala') විශේෂ විකුණුම් @else Special Sale @endif</h4>
                    </div>
                  </div>
                  <h6 class="text">@if(session()->get('language') == 'sinhala') විශේෂ වට්ටම් සදහා 5$ වට්ටමක් @else xtra $5 off on all items @endif </h6>
                </div>
              </div>
              <!-- .col --> 
            </div>
        ...
        <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
          <div class="more-info-tab clearfix ">
            ...
            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
              ...
              @foreach($categories as $category)
              <li><a data-transition-type="backSlide" href="#category{{$category->id}}" data-toggle="tab">@if(session()->get('language') == 'sinhala') {{$category->category_name_sin}} @else {{$category->category_name_en}} @endif</a></li>
              @endforeach
